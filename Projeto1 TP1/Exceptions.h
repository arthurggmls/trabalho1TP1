...
/// @file Exceptions.h
/// @brief Exceções específicas para erros de validação de domínios.
///
/// Contém classes derivadas de invalid_argument que representam
/// erros de formato ou valor inválido para diferentes tipos de domínio,
/// como CPF, códigos, datas, perfis, valores monetários, quantidades e senhas.
